	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Sat-Y?tab=repositories",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3546383294401345?spm_id_from=333.1007.0.0",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "0.0",
					url: "https://www.douyin.com/user/MS4wLjABAAAAbovo7NnDS-uucoRMf6CLQh-yHVaTF7peBu27TPbh4IU?from_tab_name=main",
					external: true,
					icon: "fa6-brands:tiktok",
				},
				{
					name: "路边一条o.0",
					url: "https://www.douyin.com/user/MS4wLjABAAAAm1NLHxmXfGA4qVcc-2YIAgt3stWfl_zaNozQ13hUR-uq-dHHYggP68kIaGRLPfg8?from_tab_name=main",
					external: true,
					icon: "fa6-brands:tiktok",
				},
			],
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Zyh-World!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
